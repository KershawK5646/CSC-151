/* Create a program to calculate and display the total cost of an item.
 * Declare variables
 * Declare contsants for the state and county tax rates
 * Get the amount of the purchase (User Input)
 * Calculate the state tax
 * Calculate the county tax
 * Calculate the total tax
 * Calculate the total price
 * Display all information about the transaction
 */
...
public class InClass_04_KershawKyler {
