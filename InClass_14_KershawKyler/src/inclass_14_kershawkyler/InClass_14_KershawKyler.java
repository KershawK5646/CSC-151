 ...
 * This program calculates the number of soccer teams that a youth league
 * may create from the number of available players. Input validation is 
 * demonstrated with while loops.
 */
package inclass_14_kershawkyler;
import javax.swing.JOptionPane;
public class InClass_14_KershawKyler {
